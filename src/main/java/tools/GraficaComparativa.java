...
public class GraficaComparativa extends JFrame {
    ...
    private DefaultCategoryDataset createDataset(String matrixSize) {
        ...
        String javaFilePath = "src/main/java/TimeResultMatriz/matriz" + matrixSize + ".txt";
        String pythonFilePath = "src/main/java/TimeResultMatriz_Python/matriz" + matrixSize + ".txt";
        ...
        for (int i = 0; i < algoritmos.size(); i++) {
            ...
            dataset.addValue(tiempoJavaMilisegundos, "Java", algoritmos.get(i));

            long tiempoPythonNanosegundos = leerTiempoDelArchivo(pythonFilePath, i);
            double tiempoPythonMilisegundos = tiempoPythonNanosegundos / 1e6;
            // Agregar el tiempo con el número del algoritmo para Python
            dataset.addValue(tiempoPythonMilisegundos, "Python", algoritmos.get(i));
        }
